...
class FinanceApp(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("IntrestRate 2.0")
        self.resize(800, 600)
        
        main_window = QWidget()
        
        self.rate_text = QLabel("Intrest Rate (%)")
    ...
    def calc_intrest(self):
        ...
        try:
            intrest_rate = float(self.rate_input.text())
        ...
        totals = [initial_investment * (1 + intrest_rate/100)**year for year in years]
        
        ax.plot(years, totals)
        ax.set_title("Intrest Chart")
        ax.set_xlabel("Year")
        ax.set_ylabel("Total")
        self.canvas.draw()
    ...
    def save_data(self):
        ...
        if dir_path:
            ...
            QMessageBox.information(self, "Save Results", "Results were saved to your Folder!")
